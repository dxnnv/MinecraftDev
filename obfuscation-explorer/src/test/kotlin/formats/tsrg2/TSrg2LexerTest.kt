...
import io.mcdev.obfex.formats.tsrg2.lang.TSrg2LayoutLexer
import org.junit.jupiter.api.Assertions
import org.junit.jupiter.api.DisplayName
import org.junit.jupiter.api.Test

@DisplayName("TSrg2 Lexer Test")
class TSrg2LexerTest {

    @Test
    @DisplayName("TSrg2 Lexer Test")
    fun test() {
        val caller = TSrg2LexerTest::class.java
        val basePath = "lexer/fixtures/test.tsrg2"
        ...
        val actual = LexerTestCase.printTokens(text.filter { it != '\r' }, 0, TSrg2LayoutLexer()).trim()
