...
class SrgMappingsFormatParserTest : ParserFixture() {

    override val parser: MappingsFormatParser = SrgMappingsFormatParser()
    ...
    override val text: String = """
        ...
        FD: ght${'$'}ds/juh net/minecraft/Test${'$'}Example/server
    ...
    fun testField2() {
        val mapping =
            def.mappings.fieldMapping("net/minecraft/Test\$Example".asClass().field("server".asFieldRef()))!!
