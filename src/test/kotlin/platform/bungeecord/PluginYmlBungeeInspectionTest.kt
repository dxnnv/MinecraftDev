...
private const val TEST_DATA_PATH = "platform/bungeecord/pluginYmlInspection"

@DisplayName("Plugin Yml BungeeCord Inspection Test")
@TestDataPath(BASE_DATA_PATH_2 + TEST_DATA_PATH)
class PluginYmlBungeeInspectionTest : BaseBungeeCordTest() {
    ...
    fun mainWrongType() {
        doTest("main: <error descr=\"Class must implement net.md_5.bungee.api.plugin.Plugin\">java.lang.String</error>")
    }
